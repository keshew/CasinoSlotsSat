...
struct PurpleSlotsView: View {
    @StateObject var viewModel =  PurpleSlotsViewModel()
    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Color(red: 104/255, green: 8/255, blue: 104/255)
                    .frame(height: 215)
                    .cornerRadius(44)
            }
            .ignoresSafeArea()
            ...
            VStack {
                        ...
                        .overlay {
                            VStack(spacing: 10) {
                                ...
                                ZStack(alignment: .leading) {
                                    Rectangle()
                                        .fill(LinearGradient(colors: [Color(red: 152/255, green: 0/255, blue: 114/255),
                                                                      Color(red: 62/255, green: 0/255, blue: 48/255)], startPoint: .top, endPoint: .bottom))
                                        .overlay {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 15) {
                        Rectangle()
                            .fill(LinearGradient(colors: [Color(red: 140/255, green: 22/255, blue: 128/255).opacity(0.7),
                                                          Color(red: 154/255, green: 23/255, blue: 141/255).opacity(0.6),
                                                          Color(red: 68/255, green: 44/255, blue: 133/255).opacity(0.7)], startPoint: .top, endPoint: .bottom))
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 184/255, green: 27/255, blue: 168/255).opacity(0.4), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 20) {
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 114/255, green: 4/255, blue: 144/255).opacity(0.5), lineWidth: 4)
                                    .overlay {
                                                ...
                                                Rectangle()
                                                    ...
                                                    .overlay {
                                                        RoundedRectangle(cornerRadius: 12)
                                                            .stroke(Color(red: 76/255, green: 128/255, blue: 71/255).opacity(0.3), lineWidth: 3)
                                                            .overlay {
                                                                HStack(spacing: 20) {
                                                                    Button(action: {
                                                                        if viewModel.bet >= 5 {
                        ...
                        Button(action: {
                            ...
                            Rectangle()
                                .fill(Color(red: 228/255, green: 1/255, blue: 255/255))
                                .overlay {
                                    RoundedRectangle(cornerRadius: 6)
                                        ...
                                        .overlay {
                                            Text("PURPLE SPIN")
                                                .font(.custom("PaytoneOne-Regular", size: 18))
                                                .foregroundStyle(Color(red: 232/255, green: 253/255, blue: 0/255))
                                        }
                                }
                                .frame(height: 32)
                                .cornerRadius(6)
