...
class PurpleSlotsViewModel: ObservableObject {
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 5
    let allFruits = ["pup1", "pup2", "pup3","pup4", "pup5", "pup6"]
    ...
    let symbolArray = [
        Symbol(image: "pup1", value: "100"),
        Symbol(image: "pup2", value: "50"),
        Symbol(image: "pup3", value: "20"),
        Symbol(image: "pup4", value: "15"),
        Symbol(image: "pup5", value: "5"),
        Symbol(image: "pup6", value: "3")
    ]
    ...
    func spin() {
        UserDefaultsManager.shared.game4Played = true
