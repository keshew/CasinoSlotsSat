    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Color(red: 9/255, green: 104/255, blue: 39/255)
                    .frame(height: 215)
                    .cornerRadius(44)
            }
            .ignoresSafeArea()
            ...
            VStack {
                        ...
                        .overlay {
                            VStack(spacing: 10) {
                                ...
                                ZStack(alignment: .leading) {
                                    Rectangle()
                                        .fill(LinearGradient(colors: [Color(red: 0/255, green: 152/255, blue: 50/255),
                                                                      Color(red: 1/255, green: 63/255, blue: 21/255)], startPoint: .top, endPoint: .bottom))
                                        .overlay {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 15) {
                        Rectangle()
                            .fill(LinearGradient(colors: [Color(red: 23/255, green: 139/255, blue: 24/255).opacity(0.7),
                                                          Color(red: 22/255, green: 154/255, blue: 47/255).opacity(0.6),
                                                          Color(red: 133/255, green: 127/255, blue: 44/255).opacity(0.7)], startPoint: .top, endPoint: .bottom))
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 37/255, green: 255/255, blue: 2/255).opacity(0.4), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 20) {
                                                ...
                                                HStack(spacing: 0) {
                                                    ForEach(0..<5, id: \.self) { col in
                                                        Rectangle()
                                                            ...
                                                            .shadow(
                                                                color: viewModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? Color.green : .clear,
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 37/255, green: 255/255, blue: 2/255).opacity(0.5), lineWidth: 4)
                                    .overlay {
                        ...
                        Button(action: {
                            ...
                            Rectangle()
                                .fill(Color(red: 3/255, green: 255/255, blue: 38/255))
                                .overlay {
                                    RoundedRectangle(cornerRadius: 6)
                                        ...
                                        .overlay {
                                            Text("LEPRE SPIN")
                                                .font(.custom("PaytoneOne-Regular", size: 18))
                                                .foregroundStyle(Color(red: 253/255, green: 18/255, blue: 0/255))
                                        }
                                }
                                .frame(height: 32)
                                .cornerRadius(6)
