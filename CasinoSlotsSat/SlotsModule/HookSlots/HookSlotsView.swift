...
struct HookSlotsView: View {
    @StateObject var viewModel =  HookSlotsViewModel()
    ...
    var body: some View {
        ZStack {
            ZStack(alignment: .top) {
                ...
                Color(red: 8/255, green: 50/255, blue: 104/255)
                    .frame(height: 215)
                    .cornerRadius(44)
            }
            .ignoresSafeArea()
            ...
            VStack {
                        ...
                        .overlay {
                            VStack(spacing: 10) {
                                ...
                                ZStack(alignment: .leading) {
                                    Rectangle()
                                        .fill(LinearGradient(colors: [Color(red: 2/255, green: 107/255, blue: 152/255),
                                                                      Color(red: 1/255, green: 33/255, blue: 63/255)], startPoint: .top, endPoint: .bottom))
                                        .overlay {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 15) {
                        Rectangle()
                            .fill(LinearGradient(colors: [Color(red: 23/255, green: 88/255, blue: 138/255).opacity(0.7),
                                                          Color(red: 22/255, green: 115/255, blue: 154/255).opacity(0.6),
                                                          Color(red: 133/255, green: 127/255, blue: 44/255).opacity(0.7)], startPoint: .top, endPoint: .bottom))
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 34/255, green: 129/255, blue: 171/255).opacity(0.4), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 20) {
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 18)
                                    .stroke(Color(red: 4/255, green: 132/255, blue: 147/255).opacity(0.5), lineWidth: 4)
                                    .overlay {
